...
const bundle = () => ({
  async writeBundle() {
    ...
    return tar
        ...
        // for instances where multiple plugin environment linked to one bb instance - works like a charm
        .pipe(fs.createWriteStream(process.env.BUILD_DIR ? `${process.env.BUILD_DIR}/${bundleName}` :  `dist/${bundleName}`))
  },
})
